...
const createAPIEndpoints = () => {
  ...
  return {
    ...
    MARKET_TOKEN_LIQUIDATIONS: (symbol) => `${API_BASE_URL}/market/tokens/${symbol}/liquidations/`,
    MARKET_TOKEN_FUND_FLOW: (symbol) => `${API_BASE_URL}/market/tokens/${symbol}/fund-flow/`,
